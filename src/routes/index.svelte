<div class="row text-center d-flex justify-content-center mt-5">
	...
	<p class="w-auto">
		Gradely 2 is an opensource cloud grade calculator. <br /> Your grades are stored in the cloud. That
		means you can access your grades on all of your devices. And if you lost your device, no problem
...
<section class="mt-10">
	<div class="row text-center justify-content-center mt-5 d-none d-sm-none d-md-flex">
		<div class="col-6">
			<img style="width: 300px;" src="/img/gradely-home-iphone.png" alt="" />
		</div>
		...
		<div class="col-12 col-md-6">
			...
			<div class="d-flex justify-content-center text-left">
				<div>
					<ul>
						<li>Semesters, lessons and grades</li>
						<li>Dream grade calculator</li>
						<li>Attach PDFs to your grade</li>
						<li>Pluspoint & average grade system</li>
						<li>Statistics</li>
						<li>Beautiful design :)</li>
					</ul>
					<p>Try it yourself, you will be convinced!</p>
				</div>
			</div>
			<h3 class="mb-3 mt-5">Supportet Platforms</h3>
...
<section id="download">
	<div class="row text-center d-flex justify-content-center mt-10 pb-10">
		...
		<a
			...
			href="https://apps.apple.com/us/app/gradely-2-grade-calculator/id1578749974"
			><i class="fab fa-apple" /> iOS</a
		>
		<a
			class="btn btn-primary  col-lg-1 col-md-2 col-5 mb-1"
			href="https://apps.apple.com/us/app/gradely-2-grade-calculator/id1578749974"
			><i class="fab fa-apple" /> MacOS</a
		>
		<a
			class="btn btn-primary col-lg-1 col-md-2 col-5 mb-1"
		...
		<a
			class="btn btn-primary col-lg-1 col-md-2 col-5 mb-1"
			href="https://www.microsoft.com/store/apps/9MW4FPN80D7D"
